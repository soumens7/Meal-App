// for creating favourite list array when it doesn't exist in localStorage
...
// Function for showing all meals related to input value
  ...
  meals.then((data) => {
    if (data.meals) {
      data.meals.forEach((element) => {
        ...
        if (isFav) {
          // if meal is favourite, show glow favourite icon
          html += `
          ...
          // if meal is not in favourite list
          html += `
              <div id="card" class="card mb-3" style="width: 20rem;">
                  <img src="${element.strMealThumb}" class="card-img-top" alt="...">
                  <div class="card-body">
      ...
      // if meal doesn't match with input value show 404 Error
      html += `
...
//this will show full meal details in main card section
...
// to show all favourites meals in favourites body
...
// function to add meal in favourite list
